...
class TestAppApp(GradioApp):
    ...
    def __init__(self):
        super().__init__(name="testapp", description="TestApp 学习模块", port=7860)
    ...
    def create_interface(self):
        ...
        with gr.Blocks(title="TestApp 学习模块") as interface:
            ...
            with gr.Row():
                with gr.Column():
                    input_text = gr.Textbox(label="输入", placeholder="请输入内容...")
            ...
            submit_btn.click(
                fn=process_input, inputs=[input_text], outputs=[output_text]
            )
